#!/bin/bash
# launch_delta_jetson.sh - Opens gnome-terminal tabs for the Delta Jetson VIO stack
#
...
#
# Usage:
#   ./launch_delta_jetson.sh              # VIO + simple mission (default)
#   ./launch_delta_jetson.sh figure8      # VIO + figure-8 mission
#   ./launch_delta_jetson.sh vio          # VIO only (no mission)
...
case "$1" in
    ...
    -h|--help|help)
        echo "Usage:"
        echo "  ./launch_delta_jetson.sh              # Simple mission (default)"
        echo "  ./launch_delta_jetson.sh figure8      # Figure-8 mission"
        echo "  ./launch_delta_jetson.sh vio          # VIO only (no mission node)"
        exit 0
        ;;
    *)
