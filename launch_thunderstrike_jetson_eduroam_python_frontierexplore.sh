...
JETSON_HOST="thunderstrike@10.90.194.74"
...
case "$1" in
    ...
    --tab8)
        ...
        echo ""
        echo "Node IDs: 1=delta, 2=thunderstrike, 3=ghost, 4=thunderstrike"
        echo ""
    ...
    -h|--help|help)
        echo "Usage:"
        echo "  ./launch_thunderstrike_jetson.sh              # Full exploration stack"
        echo "  ./launch_thunderstrike_jetson.sh explore      # Same as above"
