...
#   ./launch_ghost_jetson.sh kill         # Kill all tmux sessions on the Jetson
...
# FMU reboot; done for ghost=3 on 2026-06-09). If they differ, PX4's /fmu/* topics
...
case "$1" in
    ...
    -h|--help|help)
        echo "Usage:"
        echo "  ./launch_ghost_jetson.sh [--rviz] [--debug]"
        echo "  ./launch_ghost_jetson.sh explore      # Full exploration stack (default)"
        echo "  ./launch_ghost_jetson.sh vio          # VIO only (no exploration)"
        echo "  ./launch_ghost_jetson.sh kill         # Kill all tmux sessions on the Jetson"
        echo ""
        echo "Options:"
        ...
        echo "      Tear everything down with: ./launch_ghost_jetson.sh kill"
        echo ""
        echo "Workflow:"
